...
<body>
	...
	<main style="height: 1875px;">
		<div class="v54_2">
			<div class="interview">
				<div id="carouselExampleControls" class="carousel slide"
					...
					<button class="carousel-control-prev" id="interviewBtn01"
						type="button" data-bs-target="#carouselExampleControls"
						data-bs-slide="prev">
						<span class="carousel-control-prev-icon" aria-hidden="true"></span>
						<span class="visually-hidden">Previous</span>
					</button>
					<button class="carousel-control-next" id="interviewBtn02"
						type="button" data-bs-target="#carouselExampleControls"
						data-bs-slide="next">
		...
		<a href="/회원가입링크"> <span class="v69_22"><a
				href="${root}/member/join" class="v69_22">회원가입</a></span>
		</a> <a href="/아이디찾기링크"> <span class="v69_23"><a
				href="${root}/member/id/find" class="v69_23">아이디 찾기</a></span>
		</a> <a href="/비밀번호찾기"> <span class="v69_24"><a
				href="${root}/member/pwd/find" class="v69_24">비밀번호 찾기</a></span>
		</a>
		<div class="v69_26"></div>
		<div class="name"></div>
		<span class="v69_29">간편하게 로그인하세요</span>
		<div class="v75_31">
			<div id="carouselExample02" class="carousel slide carousel-fade"
				data-bs-ride="carousel">
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img
				...
				<button class="carousel-control-prev" id="secu01" type="button"
					data-bs-target="#carouselExample02" data-bs-slide="prev">
					<span class="carousel-control-prev-icon" aria-hidden="true"></span>
					<span class="visually-hidden">Previous</span>
				</button>
				<button class="carousel-control-next" id="secu02" type="button"
					data-bs-target="#carouselExample02" data-bs-slide="next">
					<span class="carousel-control-next-icon" aria-hidden="true"></span>
					<span class="visually-hidden">Next</span>
				</button>
			</div>
		...
		<div class="v75_32">
			<div id="carouselExample01" class="carousel slide carousel-fade"
				data-bs-ride="carousel">
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img
				...
				<button class="carousel-control-prev" id="javabtn01" type="button"
					data-bs-target="#carouselExample01" data-bs-slide="prev">
					<span class="carousel-control-prev-icon" aria-hidden="true"></span>
					<span class="visually-hidden">Previous</span>
				</button>
				<button class="carousel-control-next" id="javabtn02" type="button"
					data-bs-target="#carouselExample01" data-bs-slide="next">
					<span class="carousel-control-next-icon" aria-hidden="true"></span>
					<span class="visually-hidden">Next</span>
				</button>
			</div>
		...
		<span class="v75_59">#디지털컨버전스</span><span class="v75_65">#자바개발자</span><span
			class="v75_60"># 실무에서 일하는 것처럼 배우자</span><span class="v75_66">#오전/
			오후 자습시간 활용</span><span class="v75_61">#이승철 강사님</span><span class="v75_67">#심원용
			강사님</span>
		</div>
