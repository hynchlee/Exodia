			...
			<%@ include file="/WEB-INF/views/common/header.jsp" %>
				<main>
					<div class="tit">
						...
						<div class="tit2">
							<span>심삼용&nbsp;</span> <span class="score">${submitAnswerList[0].score}</span>
							<span>점</span>
						</div>
					</div>
					<br> <br> <br> <br> <br>
					...
					<% int i=1; %>
						<c:forEach items="${submitAnswerList}" var="vo">
							...
							<div class="problem">
								<div class="rere">
									<div>
										<%=i%>. ${vo.problem} (<span class="score">${vo.scorePoint}</span>점)
									</div>
								...
								<div class="hi">
									<textarea readonly style="resize: none;"
										name="answer"> ${vo.submitAnswer}</textarea>
						...
						<br>
						<div class="finish">
							<button class="finish-btn" onclick="location.href='${root}/lecture/test/list'">확인 완료</button>
						</div>
