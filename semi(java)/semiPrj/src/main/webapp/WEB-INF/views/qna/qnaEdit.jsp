...
<body>
	<%@ include file="/WEB-INF/views/common/header.jsp" %>
		...
		<main>
            ...
            <form action="${root}/qna/edit?qno=${qvNo.qnaNo}" method="post">
                ...
                <div class="write_wrap">
                    <input type="text" name="boardTitle" value="${qvNo.qnaTitle}" required>
                    <select name="boardCategoryNo" id="select_category" >
                        <option>문의게시판</option>
                    </select>

                    <textarea name="boardContent" id="summernote">${qvNo.qnaContent}</textarea>
