...
<link href="${root}/static/css/letter/receive-letter.css"
	rel="stylesheet">
</head>
	...
	<main>
				...
				<form action="${root}/letter/receive" method="post">
					<div id="select-button">
						<img src="${root}/static/img/letter/받은 쪽지.png"> <input
							type="submit" value="받은 쪽지" id="receive-letter" disabled>
					</div>
				</form>
			</div>
			<div>
		...
		<div id="letter-list">
			<table>
				<thead>
					<tr>
						<td colspan="5"><select name="searchType" id="">
								<option value="writer">작성자</option>
								<option value="title">제목</option>
						</select> <input type="text" name="searchValue">
							<button>검색하기</button></td>
					</tr>
					<tr id="trHead">
