		...
		<main>
                ...
                <table class="board_view">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <c:if test="${empty cvNo.modifyDate}">
                            	<td></td>
                            </c:if>
                            <c:if test="${not empty cvNo.modifyDate }">
            ...
            <div id="reply-area">
                <input type="hidden" name="bno" value="${cvNo.boardNo}">
                	<c:choose>
                		<c:when test="${empty loginMember || not empty loginAdmin}">
                		</c:when>
                		<c:otherwise>
...
<script>
    ...
    //           updateComment(replyNo, updatedContent);
    //         } else {
